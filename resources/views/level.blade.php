            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Add Approval Stage</li>
                    </ol>
                </div>
            </div>
        </div>
...
<td>Action</td>
                  ...
                  @for($n=1; $selectlevel >= $n; $n++) 
                      ...
                      <tr>
                        ...
                        <td>{{$n}} Stage</td>
                        <td style="width: 10%">
                         <i data-toggle="modal" data-target="#modal-delete" 
                         class="fa fa-trash" style="color: red" title="Delete level"></i> 
