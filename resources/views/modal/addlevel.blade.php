    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add Approval Stage</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{route('insertlevel')}}" method="POST">
           @csrf     <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                               <label>Enter Number of approval stages </label>
                                <input type="number" name="level" class="form-control" placeholder="" required="" autocomplete="off">
                            </div>
                        </div>
                    </div>
