            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">verify Request</li>
                    </ol>
                </div>
            </div>
        </div>
                  ...
                  <tbody>
                   ...
                   @foreach($selectRequest as $row)
                      <tr>
                        ...
                        <td> <button type="button" disabled="" class="btn btn-primary" style="border:15px;background-color:green">{{$row->status}}..</button></td>
                        <td>{{$row->verify_by}}</td>
                        <td>{{$row->date}}</td>
                        <td style="width: 10%"><i data-toggle="modal" data-target="#modal-edits{{$row->id}}" 
                        class="fa fa-edit" style="color: green" title="Edit Employee"></i> |
                         <i data-toggle="modal" data-target="#modal-delete{{$row->id}}" 
                         class="fa fa-trash" style="color: red" title="Delete Employee"></i> 
